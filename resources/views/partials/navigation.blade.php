            ...
            @auth
                @if(auth()->user()->hasRole('admin'))
                    ...
                    <div class="dropdown dropdown-top dropdown-end">
                        <label tabindex="0" class="@if(request()->routeIs('admin.categories*') || request()->routeIs('admin.products*') || request()->routeIs('admin.partners*') || request()->routeIs('admin.discounts*') || request()->routeIs('admin.config*')) dock-active @endif">
                            <svg class="size-[1.2em]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 mb-2">
                            ...
                            <li><a href="{{ route('admin.partners') }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <!-- Reports Dropdown -->
                    <div class="dropdown dropdown-top dropdown-end">
                        <label tabindex="0" class="@if(request()->routeIs('admin.reports*')) dock-active @endif">
                            <svg class="size-[1.2em]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 mb-2">
                            ...
                            <li><a href="{{ route('admin.reports.expenses') }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
