            ...
            @if ($activeTab === 'input-awal')
                <div class="space-y-6">
                    <div class="alert alert-info">
                        ...
                        <span>Input stok awal untuk setiap produk di awal hari. Stok ini akan menjadi dasar perhitungan
                            stok tersedia.</span>
                    </div>
                                        ...
                                        <tr class="{{ $status['needs_stock_in'] ? '' : 'bg-success/10' }}">
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    <div class="avatar placeholder">
                                                        <div class="bg-primary text-primary-content rounded-full w-8">
                                                            <span
                                                                class="text-xs">{{ substr($status['product']->name, 0, 1) }}</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <td>
                                                <div class="badge badge-outline">
                                                    {{ $status['product']->category->name }}</div>
                                            </td>
                                            <td>
                ...
                <div class="space-y-6">
                    <div class="alert alert-warning">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            class="stroke-current shrink-0 w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.996-.833-2.33 0L3.5 16.5c-.77.833.192 2.5 1.732 2.5z">
                            </path>
                        </svg>
                        <span>Input stok fisik yang tersisa di akhir hari. Sistem akan menghitung selisih
                            otomatis.</span>
                    </div>
                                                ...
                                                <div class="flex items-center space-x-3">
                                                    <div class="avatar placeholder">
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-xs">{{ substr($product->name, 0, 1) }}</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item['difference'] !== null)
                                                <div
                                                    class="font-semibold {{ $item['difference'] == 0 ? 'text-success' : ($item['difference'] > 0 ? 'text-warning' : 'text-error') }}">
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-8">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-base-content/70">Tidak ada data rekonsiliasi untuk
